...
public:
    Piano(AnalysisMatrix* pitches, AnalysisMatrix* rhythms, AnalysisMatrix* articulations, std::vector<short>& dynamics, std::vector<Row> RhRows, std::vector<Row> LHRows);
    ~Piano() = default;
